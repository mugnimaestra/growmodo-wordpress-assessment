...
| Plugins where necessary | **Not applicable** | The required assessment features work with native WordPress APIs, so no extra contact-form, CPT, or field plugin was required. | [functions.php](wordpress/theme/functions.php) |
